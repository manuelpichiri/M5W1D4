...
const BooksCover = ({ books, setBooks }) => {
      ...
      <Row>
        <div className="d-flex align-items-center">
          <input
            ...
            type="text"
            value={inputText}
            onChange={targetValuePlusReStockBook} //controlla il valore scritto all'interno dell'input e in caso di input vuoto esegue setta i libri allo stato iniziale
          ></input>
